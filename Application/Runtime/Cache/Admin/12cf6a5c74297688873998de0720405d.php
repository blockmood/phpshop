...
<head>
	<title></title>
	<link rel="stylesheet" href="/shop/Public/datepicker/jquery-ui-1.9.2.custom.min.css">
...
<form method="get" action="">
	...
	时    间:从<input type="text" name="start_addtime" id="st">到<input type="text" name="end_addtime" id="stl"><br/>
